...
<main id="primary" class="container px-6 mx-auto md:px-0 md:max-w-2xl xl:container">
  ...
  <div class="grid grid-flow-row-dense gap-y-10 mt-[48px] md:grid-cols-3 md:mt-[137px] md:gap-y-40 md:gap-x-[62px] xl:mt-[173px] xl:gap-y-[70px] xl:gap-x-[90px]" id="content_list">
    <?php
    // Build meta query
